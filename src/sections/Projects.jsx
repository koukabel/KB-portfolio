  ...
  return (
    <section className="c-space my-20">
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
        <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200 exp-block  rounded-lg">
          ...
          <div className="flex flex-col gap-5 text-white-600 my-5">
            <p className="text-black-600 text-2xl font-semibold animatedText">{currentProject.title}</p>

            <p className="animatedText text-black-200">{currentProject.desc}</p>
