...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen w-full flex flex-col relative" id="home">
      <div className="w-full mx-auto flex flex-col sm:mt-36 c-space gap-1 hero-text">
        <p className="sm:text-3xl text-xl font-medium text-black text-center font-generalsans">
          Hi, I am Khouloud <span className="waving-hand">👋</span>
        </p>
        <p className="hero_tag text-gray_gradient">A React & Node developer</p>
      </div>
